...
gulp.task('js', function() {
	return gulp.src([
		...
		'app/libs/js/jquery.nicescroll.min.js',
		'app/libs/js/accordion-min.js',
		'app/libs/js/bootstrap.min.js',
		'app/libs/js/jquery.maskedinput.min.js',
		'app/libs/js/ion.rangeSlider.min.js',
		'app/libs/js/jquery.matchHeight.js',
		'app/libs/js/slideout.min.js',
		'app/libs/js/jquery.arcticmodal-0.3.min.js',
		'app/libs/js/dynamic-adapt.min.js',
